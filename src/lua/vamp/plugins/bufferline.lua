return {
	...
	opts = {
		options = {
			...
			custom_filter = function(buf, _)
				return vim.fn.bufname(buf):match("[No Name]") or vim.bo[buf].filetype == "help"
			end,
	...
	config = function(_, opts)
		...
		vim.keymap.set({ "n", "x" }, "<leader>tt", "<cmd>BufferLinePick<cr>", { desc = "Buffers", noremap = true })

		vim.keymap.set({ "n", "x" }, "<leader>yr", ":BufferLineTabRename ", { desc = "Rename tab", noremap = true })

return {
	...
	opts = {
		...
		on_attach = function(_)
			...
			vim.keymap.set({ "n", "x" }, "<leader>ngd", gitsigns.diffthis, { desc = "Diff", noremap = true })
			...
			vim.keymap.set("n", "<leader>ngr", gitsigns.reset_hunk, { desc = "Reset hunk", noremap = true })
			...
			vim.keymap.set("n", "<leader>ngs", gitsigns.stage_hunk, { desc = "Stage hunk", noremap = true })
			...
			vim.keymap.set("n", "<leader>ngu", gitsigns.undo_stage_hunk, { desc = "Undo stage hunk", noremap = true })
